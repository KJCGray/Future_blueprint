...
function SearchResult({ Jobdata }) {
  return (
    <div className="w-3/4 h-auto p-2 mx-12">
      {Jobdata.map((jobs) => (
        <div className="w-full h-48 p-2 border border-solid border-zinc-300" key={jobs.job_url}>
          ...
          <div className="flex w-full">
            <div className="w-5/6 h-16 overflow-auto whitespace-pre-line no-scrollbar">
              {jobs.job_content}
            </div>
            <div className="flex items-center justify-center p-2 mt-auto ml-auto text-sm bg-orange-100 rounded-md w-28 h-fit hover:bg-orange-200">
